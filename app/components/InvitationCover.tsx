    ...
    >
      ...
      <div className="relative z-10 flex flex-1 flex-col items-center justify-between px-6 pb-10 pt-16 sm:px-10 sm:pb-14">
        ...
        <div className="flex flex-col items-center gap-7 text-center">
          ...
          />
          <h1
            className="animate-fade-up font-[family-name:var(--font-display)] text-[15vw] italic leading-[0.95] text-[color:var(--color-ivory)] sm:text-[9vw] md:text-[7rem]"
          ...
          <div
            className="animate-fade-up flex items-center gap-4 text-[color:var(--color-champagne)]"
        ...
        >
          <p className="max-w-[22ch] text-center font-[family-name:var(--font-body)] text-xs leading-relaxed tracking-[0.08em] text-[color:var(--color-champagne)]/80">
          ...
          <button
            type="button"
            onClick={onOpen}
            className="focus-ring group relative flex h-16 w-16 items-center justify-center rounded-full border border-[color:var(--color-gold-soft)]/70 text-[color:var(--color-ivory)] transition-transform duration-500 hover:scale-105 active:scale-95"
          ...
          <span className="eyebrow text-[color:var(--color-champagne)]/70">Tap the seal to begin</span>
        </div>
      </div>
