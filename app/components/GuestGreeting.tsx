...
export default function GuestGreeting({ guestName }: { guestName: string }) {
  return (
    <section className="relative flex min-h-[85vh] flex-col items-center justify-center bg-[color:var(--color-ivory)] px-8 py-24 text-center sm:px-16">
      <Reveal>
        <p className="eyebrow mb-8">Dear</p>
      </Reveal>
      <Reveal delay={150}>
        <h2 className="font-[family-name:var(--font-display)] text-4xl italic leading-tight text-[color:var(--color-bark)] sm:text-6xl">
          {guestName}
        </h2>
      </Reveal>
      <Reveal delay={300}>
      ...
      <Reveal delay={550}>
        <p className="mt-10 font-[family-name:var(--font-display)] text-2xl italic text-[color:var(--color-gold)]">
